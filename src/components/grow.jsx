...
import CounterStat from "./CounterStat"; // Or move it to the same file above if needed

const Grow = () => {
  return (
    <section id="grow" className="py-28 px-6 flex justify-center items-center">
      <div className="bg-soft/10 backdrop-blur-md rounded-3xl p-10 max-w-5xl w-full text-center border border-white/10 shadow-lg">
        <h1 className="text-4xl md:text-5xl font-bold text-light mb-6">
          Let's grow together!
        </h1>
        <p className="text-muted mb-12 max-w-3xl mx-auto text-lg">
        ...
        {/* ✅ Use the reusable animated CounterStat components */}
